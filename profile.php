<?php
    ...
    // Definindo se o usuário estaria verificando seu perfil ou o perfil de outro usuário
    if(empty($id)) {

        // Se o id estiver vazio mas estivermos recebendo o ID do userData, defina o id a partir do que recebemos
        if(!empty($userData)) {
    ...
    // Resgatando nome e imagem de usuário
    ...
    // Resgatando filmes que o usuário adicionou
