<?php
    ...
    // Não é necessária a verificação, o header não é uma página privada
...
<body>
    <header>
        <nav id="main-navbar" class="navbar navbar-expand-lg">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar" aria-controls="navnar" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav">
                    <!-- Caso tenha userData, o usuário está logado -->
                    <?php if($userData): ?>
